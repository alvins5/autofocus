    <!-- Home -->
<div>
    <div id="home" class="main-content container mx-auto mt-8 relative px-4 pt-28">
...
<div id="product" class="container mx-auto p-4">
    <div class="mb-8">
        ...
        <div class="bg-white p-4 rounded-lg items-center grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 text-gray-900">
            <img alt="SONY logo" class="tile ml-7 lg:ml-20" height="100" src="img/sony.jpg" width="100" />
            <img alt="FUJIFILM logo" class="tile ml-3 lg:ml-20" height="100" src="img/fujifilm.png" width="100" />
            <img alt="Canon logo" class="tile ml-7 lg:ml-20" height="100" src="img/canon.png" width="100" />
            <img alt="Nikon logo" class="tile ml-3 mb-3 lg:ml-20" height="100" src="img/nikon.png" width="100" />
        </div>
    </div>
    <div>
        <h2 class="text-xl font-semibold mb-4">
        ...
        <div class="bg-white p-4 rounded-lg grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 text-gray-900">
            <div class="flex flex-col items-center">
                <img alt="Digital Camera" class="tile h-24 mb-2" height="100" src="img/digitalcam.avif" width="100" />
                <span>
                    Digital Cameras
                </span>
            </div>
            <div class="flex flex-col items-center">
                <img alt="Lenses" class="tile h-24 mb-2" height="100" src="img/lenses.jpg" width="100" />
                <span>
                    Lenses
                </span>
            </div>
            <div class="flex flex-col items-center">
                <img alt="Accessories" class="tile h-19 mt-4 mb-5" height="100" src="img/accessories.webp" width="100" />
                <span>
                    Accessories
                </span>
            </div>
            <div class="flex flex-col items-center">
                <img alt="Video Camera" class="tile h-24 mb-2" height="100" src="img/videocamera.webp" width="100" />
                <span>
                    Video Cameras
                </span>
            </div>
            <div class="flex flex-col items-center">
                <img alt="Tripods" class="tile h-30 mb-2" height="100" src="img/Tripod.jpg" width="100" />
                <span>
                    Tripods
                </span>
            </div>
